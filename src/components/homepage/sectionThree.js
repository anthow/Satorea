...
const SectionThree = () => {
  ...
  <section className="m-auto w-10/12">
    <h2 className=" text-3xl mb-10">{data.datoCmsHomepage.titreIntroductionService}</h2>
    <p className="mb-20">
    ...
    <div className="flex flex-col mb-20 items-center md:grid grid-cols-2 gap-x-4">
      ...
      <div>
        <h3 className="text-2xl font-black mb-5">{data.datoCmsHomepage.coachingTitre}</h3>
    ...
    <div className="flex flex-col items-center md:grid grid-cols-2 gap-x-4">
      <div className="order-2 md:order-1">
        <h3 className="text-2xl font-black mb-5">{data.datoCmsHomepage.titreFormationCollective}</h3>
