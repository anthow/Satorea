...
const Home = () => {
  ...
  <section className=" w-full m-auto  items-center flex flex-col md:grid grid-cols-2">
    <div className=" m-auto md:m-0 w-10/12 lg:w-8/12 self-start justify-self-center md:pt-20    order-1">
    <div className="lg:text-6xl text-4xl mt-10 lg:mt-0   md:w-12/12 titrehomepage mb-2 flex flex-col items-center  break-normal"
        ...
        className="relative bottom-14 md:ml-0 md:bottom-24 w-1/12   lg:w-max left-2/3 lg:left-96  " />
  ...
  <figure className=" md:justify-self-end   h-fit order-2">
  <GatsbyImage
  className=""
